...
const markdown = fs.readFileSync('/Users/cjoh/Dropbox (Maestral)/coaching101/Facilitator_Manual.md', 'utf8');
    ...
    footers: {
      default: new Footer({
        children: [new Paragraph({
          alignment: AlignmentType.CENTER,
          children: [
            new TextRun({ text: "Coaching 101 Facilitator Manual | Version 1.0 | Core Values Recovery  |  Page ", size: 18, color: GRAY, font: "Roboto Condensed" }),
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync("/Users/cjoh/Dropbox (Maestral)/coaching101/Facilitator_Manual.docx", buffer);
  console.log("✅ Facilitator Manual created successfully!");
  console.log("📄 File: /Users/cjoh/Dropbox (Maestral)/coaching101/Facilitator_Manual.docx");
